 ...
 */
export function checkCompleteRows(board) {
    var removedRows = []
 ...
 */
export function generateTetromino(board) {
    // There are 5 possible tetrominos
    var shapeChoice = Math.floor(Math.random() * 5)
    var middleColumn = Math.floor(board[0].length / 2)
 ...
 */
export function getNextShape(board, shapeQueue) {
